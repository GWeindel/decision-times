...
**Installation instruction as of the 2025-10-23**

```bash
# Create environment
python3 -m venv ~/venv/dec_times #or python
# Activate it
source ~/venv/dec_times/bin/activate  
# Installing dependencies for the code not shipped with hmp
python -m pip install jupyterlab bambi arviz #not included with hmp
pip install hmp==1.0.0-b2 #Will be available on the 26 October 2025
jupyter lab
```
